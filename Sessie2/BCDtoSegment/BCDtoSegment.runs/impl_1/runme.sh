...
HD_PWD='C:/Users/tijsv/Desktop/UA sem2/DigitaleElektronica/Sessie2/BCDtoSegment/BCDtoSegment.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log TB_BCDtoSegm.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source TB_BCDtoSegm.tcl -notrace
