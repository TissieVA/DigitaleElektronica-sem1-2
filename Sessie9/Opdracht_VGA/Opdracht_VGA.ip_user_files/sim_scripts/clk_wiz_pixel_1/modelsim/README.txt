...
#
# Generated by export_simulation on Fri Apr 26 15:03:16 +0200 2019
#
################################################################################
...
'-reset_run' switch to the './clk_wiz_pixel.sh' script.

./clk_wiz_pixel.sh -reset_run
...
./clk_wiz_pixel.sh -noclean_files

For more information on the script, please type './clk_wiz_pixel.sh -help'.
