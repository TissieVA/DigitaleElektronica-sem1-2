...
HD_PWD='D:/tijsv/Documents/UAsem2/DigitaleElektronica/Sessie9/Opdracht_VGA/Opdracht_VGA.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Red_screen.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Red_screen.tcl -notrace
