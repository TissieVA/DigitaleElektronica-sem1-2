...
HD_PWD='D:/tijsv/Documents/UAsem2/DigitaleElektronica/Sessie9/Opdracht_VGA/Opdracht_VGA.runs/clk_wiz_pixel_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log clk_wiz_pixel.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source clk_wiz_pixel.tcl
