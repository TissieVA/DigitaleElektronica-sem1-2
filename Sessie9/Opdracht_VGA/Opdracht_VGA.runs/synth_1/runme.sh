...
HD_PWD='D:/tijsv/Documents/UAsem2/DigitaleElektronica/Sessie9/Opdracht_VGA/Opdracht_VGA.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Red_screen.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Red_screen.tcl
