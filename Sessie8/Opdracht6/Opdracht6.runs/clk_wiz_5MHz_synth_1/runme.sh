...
HD_PWD='D:/tijsv/Documents/UA sem2/DigitaleElektronica/Sessie8/Opdracht6/Opdracht6.runs/clk_wiz_5MHz_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log clk_wiz_5MHz.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source clk_wiz_5MHz.tcl
