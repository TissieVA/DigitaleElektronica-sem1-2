...
#
# Generated by Vivado on Tue Apr 23 15:01:39 +0200 2019
...
compile()
{
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"$ref_dir/../../../ipstatic" \
    "$ref_dir/../../../../Opdracht6.srcs/sources_1/ip/clk_wiz_0_5/clk_wiz_0_clk_wiz.v" \
    "$ref_dir/../../../../Opdracht6.srcs/sources_1/ip/clk_wiz_0_5/clk_wiz_0.v" \
  2>&1 | tee -a vlogan.log
