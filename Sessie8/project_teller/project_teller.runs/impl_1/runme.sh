...
HD_PWD='D:/tijsv/Documents/UAsem2/DigitaleElektronica/Sessie8/project_teller/project_teller.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Teller.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Teller.tcl -notrace
