...
HD_PWD='D:/tijsv/Documents/UAsem2/DigitaleElektronica/Sessie8/project_teller/project_teller.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Teller.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Teller.tcl
